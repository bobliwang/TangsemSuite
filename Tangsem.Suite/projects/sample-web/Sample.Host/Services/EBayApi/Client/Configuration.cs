...
namespace IO.Swagger.Client
{
  ...
  public class Configuration : IReadableConfiguration
  {
    ...
    {
      this.UserAgent = "Swagger-Codegen/1.0.0/csharp";
      this.BasePath = "https://api.ebay.com/sell/fulfillment/v1";
    ...
    public Configuration(
        ...
        string basePath = "https://api.ebay.com/sell/fulfillment/v1") : this()
    {
    ...
    public virtual int Timeout
    {
      ...
      get { return this.ApiClient.RestClient.Timeout; }
    ...
    {
      return new ApiClient(this.BasePath) { Configuration = this };
    }
    ...
    public static String ToDebugReport()
    {
      ...
      report += "    Version of the API: v1.8.0\n";
