...
namespace IO.Swagger.Client
{
  ...
  public partial class ApiClient
  {
    ...
    public ApiClient()
    {
      ...
      this.RestClient = new RestClient("https://api.ebay.com/sell/fulfillment/v1");
    }

    /// <summary>
    /// Initializes a new instance of the <see cref="ApiClient" /> class
    /// with default base path (https://api.ebay.com/sell/fulfillment/v1).
    /// </summary>
    /// <param name="config">An instance of Configuration.</param>
    public ApiClient(Configuration config)
    {
      this.Configuration = config ?? IO.Swagger.Client.Configuration.Default;
    ...
    public ApiClient(String basePath = "https://api.ebay.com/sell/fulfillment/v1")
    {
