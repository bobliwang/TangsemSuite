...
namespace IO.Swagger.Model
{
    ...
    public partial class ExtendedContact :  IEquatable<ExtendedContact>, IValidatableObject
    {
        ...
        /// <param name="email">This field shows the email address of the buyer. The email address of a buyer will only be shown for the first two weeks after order creation. Two weeks after order creation, this field will stop getting returned. Note: This field will always show the email address of the buyer even with a Global Shipping Program shipment..</param>
        /// <param name="fullName">The full name of the buyer or eBay shipping partner..</param>
        ...
        /// <summary>
        /// This field shows the email address of the buyer. The email address of a buyer will only be shown for the first two weeks after order creation. Two weeks after order creation, this field will stop getting returned. Note: This field will always show the email address of the buyer even with a Global Shipping Program shipment.
        /// </summary>
        /// <value>This field shows the email address of the buyer. The email address of a buyer will only be shown for the first two weeks after order creation. Two weeks after order creation, this field will stop getting returned. Note: This field will always show the email address of the buyer even with a Global Shipping Program shipment.</value>
        ...
        /// </summary>
        /// <value>The full name of the buyer or eBay shipping partner.</value>
