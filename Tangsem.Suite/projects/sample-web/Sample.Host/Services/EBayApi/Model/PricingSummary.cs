...
namespace IO.Swagger.Model
{
    ...
    public partial class PricingSummary :  IEquatable<PricingSummary>, IValidatableObject
    {
        ...
        /// <param name="priceDiscountSubtotal">priceDiscountSubtotal.</param>
        /// <param name="priceSubtotal">priceSubtotal.</param>
        /// <param name="tax">tax.</param>
        /// <param name="total">total.</param>
        public PricingSummary(Amount adjustment = default(Amount), Amount deliveryCost = default(Amount), Amount deliveryDiscount = default(Amount), Amount fee = default(Amount), Amount priceDiscountSubtotal = default(Amount), Amount priceSubtotal = default(Amount), Amount tax = default(Amount), Amount total = default(Amount))
        {
        ...
        /// <summary>
        /// Gets or Sets PriceDiscountSubtotal
        /// </summary>
        ...
        public bool Equals(PricingSummary input)
        {
            ...
            return 
                ...
                (
                    this.PriceDiscountSubtotal == input.PriceDiscountSubtotal ||
                    (this.PriceDiscountSubtotal != null &&
                    this.PriceDiscountSubtotal.Equals(input.PriceDiscountSubtotal))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PriceDiscountSubtotal != null)
                    hashCode = hashCode * 59 + this.PriceDiscountSubtotal.GetHashCode();
