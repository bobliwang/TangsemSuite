...
namespace IO.Swagger.Model
{
    ...
    public partial class Error :  IEquatable<Error>, IValidatableObject
    {
        ...
        /// <param name="domain">The name of the domain containing the service or application. For example, sell is a domain..</param>
        ...
        /// <param name="longMessage">An expanded version of the message field. Maximum length: 200 characters.</param>
        /// <param name="message">A message about the error or warning which is device agnostic and readable by end users and application developers. It explains what the error or warning is, and how to fix it (in a general sense). If applicable, the value is localized to the end user&#39;s requested locale. Maximum length: 50 characters.</param>
        ...
        /// <param name="subdomain">The name of the domain&#39;s subsystem or subdivision. For example, fulfillment is a subdomain in the sell domain..</param>
