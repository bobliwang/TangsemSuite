...
namespace IO.Swagger.Model
{
    ...
    public partial class LineItemProperties :  IEquatable<LineItemProperties>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="buyerProtection">A value of true indicates that the line item is covered by eBay&#39;s Buyer Protection program..</param>
        ...
        /// <param name="soldViaAdCampaign">This field is only returned if true and indicates that the line item was sold as a result of a seller&#39;s ad campaign..</param>
        ...
        /// </summary>
        /// <value>This field is only returned if true and indicates that the purchase occurred by the buyer and seller mutually agreeing on a Best Offer amount. The Best Offer feature can be set up for any listing type, but if this feature is set up for an auction listing, it will no longer be available once a bid has been placed on the listing.</value>
        ...
        /// </summary>
        /// <value>This field is only returned if true and indicates that the line item was sold as a result of a seller&#39;s ad campaign.</value>
