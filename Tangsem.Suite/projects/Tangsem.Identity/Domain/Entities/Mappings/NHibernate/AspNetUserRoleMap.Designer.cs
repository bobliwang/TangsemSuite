...
{
  /// <summary>
  /// The mapping configuration for AspNetUserRole.
  /// </summary>
  public partial class AspNetUserRoleMap : ClassMap<AspNetUserRole>
  {
    /// <summary>
    ...
    /// The constructor.
    /// </summary>
    public AspNetUserRoleMap(AttributeStore attributes, MappingProviderStore providers)
      : base(attributes, providers)
    {
      this.Providers = providers;


      this.Table("[AspNetUserRole]");
