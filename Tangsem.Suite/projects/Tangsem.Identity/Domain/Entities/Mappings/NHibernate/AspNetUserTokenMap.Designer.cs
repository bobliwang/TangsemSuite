...
{
  /// <summary>
  /// The mapping configuration for AspNetUserToken.
  /// </summary>
  public partial class AspNetUserTokenMap : ClassMap<AspNetUserToken>
  {
    /// <summary>
    /// The default constructor.
    /// </summary>
    public AspNetUserTokenMap()
    ...
    /// The constructor.
    /// </summary>
    public AspNetUserTokenMap(AttributeStore attributes, MappingProviderStore providers)
      : base(attributes, providers)
    {
      this.Providers = providers;


      this.Table("[AspNetUserToken]");
