...
{
  public partial class NgFilterComponentHtml: ISingleTableMetadataTemplate
  {
    public NgFilterComponentHtml(GeneratorConfiguration configuration, TableMetadata tableMetadata)
    {
    ...
    public string GetPathToSave(GeneratorConfiguration genConfig)
    {
      ...
      return Path.Combine(
        ...
        $"{this.TableMetadata.EntityName.Lf()}-filter.component.html");
    }
  }
}