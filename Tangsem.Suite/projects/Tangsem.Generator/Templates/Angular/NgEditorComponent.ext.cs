...
{
  public partial class NgEditorComponent: ISingleTableMetadataTemplate
  {
    public NgEditorComponent(GeneratorConfiguration configuration, TableMetadata tableMetadata)
    {
    ...
    public string GetPathToSave(GeneratorConfiguration genConfig)
    {
      ...
      return Path.Combine(
        ...
        $"{this.TableMetadata.EntityName.Lf()}-editor.component.ts"
      );
    }
