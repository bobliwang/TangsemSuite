...
{
  public partial class NgRoutingModule: IMultipleTableMetadataTemplate
  {
    public NgRoutingModule(GeneratorConfiguration configuration, List<TableMetadata> tableMetadatas)
    {
    ...
    public string GetPathToSave(GeneratorConfiguration genConfig)
    {
      return Path.Combine(
        ...
        this.Configuration.RepositoryName.Lf() + "-routing.module.ts"
      );
    }
