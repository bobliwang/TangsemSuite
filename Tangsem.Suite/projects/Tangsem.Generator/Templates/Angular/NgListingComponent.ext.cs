...
{
  public partial class NgListingComponent: ISingleTableMetadataTemplate
  {
    public NgListingComponent(GeneratorConfiguration configuration, TableMetadata tableMetadata)
    {
    ...
    public string GetPathToSave(GeneratorConfiguration genConfig)
    {
      return Path.Combine(
        ...
        $"{this.TableMetadata.EntityName.Lf()}-listing.component.ts");
    }
