...
{
  public partial class NgEditorComponentHtml: ISingleTableMetadataTemplate
  {
    public NgEditorComponentHtml(GeneratorConfiguration configuration, TableMetadata tableMetadata)
    {
    ...
    public string GetPathToSave(GeneratorConfiguration genConfig)
    {
      return Path.Combine(
        ...
        $"{this.TableMetadata.EntityName.Lf()}-editor.component.html"
      );
    }
